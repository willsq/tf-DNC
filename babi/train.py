...
# Model parameters
tf.flags.DEFINE_integer("units", 256, "Size of LSTM hidden layer.")
...
tf.flags.DEFINE_string("checkpoint_dir", "exp", "Checkpointing directory.")
...
def train(num_training_iterations, report_interval):
    ...
    train_loss = tf.reduce_mean(
        target_mask *
        tf.nn.softmax_cross_entropy_with_logits_v2(logits=output_logits, labels=target_output)
    )
